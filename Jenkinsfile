def DEFAULT_RUBY_VERSION = '3.0.6'
...
def MACOS_ENV = ["TEST_RUBY_VERSION=${DEFAULT_RUBY_VERSION}", "COMPILE_CONCURRENCY=${MACOS_COMPILE_CONCURRENCY}", "WORKSPACE=${env.WORKSPACE}"]
